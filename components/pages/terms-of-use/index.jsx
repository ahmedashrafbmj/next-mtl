          ...
          <div className="col-md-12">
            <h5 className="mt-4">
              {" "}
                ...
                The Balance on Life website located at balanceonlife.com is a
                copyrighted work belonging to Balance on Life. Certain features
            ...
            <h3 className="mt-5">Accounts</h3>
            <h5 className="mt-2">
              Account Creation. For you to use the Site, you have to start an
              account and provide information about yourself. You warrant that:
              (a) all required registration information you submit is truthful,
              up-to-date and accurate; (b) you will maintain the accuracy of
              such information. You may delete your Account at any time by
            ...
            <h5 className="mt-4">
              ...
              approve to immediately notify the Company of any unauthorized use,
              or suspected unauthorized use of your Account. Company cannot and
              will not be liable for any loss or damage arising from your
              failure to comply with the above requirements.
            </h5>
            <h3 className="mt-5">Access to the Site</h3>
            <h5 className="mt-2">
            ...
            <h5 className="mt-4">
              ...
              content are owned by Company or Company&apos suppliers. Note that
            ...
            <h3 className="mt-5">User Content</h3>
            <h5 className="mt-2">
            ...
            <h5 className="mt-4">
              ...
              or (iv) that is in violation of any law, regulation, or
            ...
            <h5 className="mt-4">
              Cookies and Web Beacons. Like any other website, Balance on Life
            ...
            <h3 className="mt-5">Disclaimers</h3>
            <h5 className="mt-2">
            ...
            <h3 className="mt-5">Limitation on Liability</h3>
            <h5 className="mt-2">
            ...
            <h3 className="mt-5">Copyright Policy.</h3>
            <h5 className="mt-2">
            ...
            <h5 className="mt-4">your physical or electronic signature;</h5>
            <h5 className="mt-4">
            ...
            <h5 className="mt-4">
              ...
              Company should be sent to: Company Address. After the Notice is
            ...
            <h5 className="mt-4">
              ...
              within Oklahoma County, Oklahoma, for such purposes.
            </h5>
            <h5 className="mt-4">
            ...
            <h6>Address: P.O. Box 6895, Edmond, Ok, 73083</h6>
            <h6>Email: contact@balanceonlife.com</h6>
            </div>
          </div>
        </div>
      </div>
