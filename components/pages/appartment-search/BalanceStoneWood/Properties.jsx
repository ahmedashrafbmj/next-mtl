...
export default function PropertiesBalanceWoodStone() {
    return (
                                ...
                                <div className="property-box">
                                    ...
                                    <div className="detail">
                                        ...
                                        <ul className="facilities-list clearfix">
                                            <li>
                                                <i className="flaticon-square" /> 1100 Sq Ft
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <i className="flaticon-vehicle" /> 1 Garage 
                                            </li>
                                            <li>
                                ...
                                <div className="property-box">
                                    <div className="property-thumbnail">
                                        <a href="#" className="property-img">
                                            ...
                                            <div className="price-box">1250<small>/mo</small></div>
