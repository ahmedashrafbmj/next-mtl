...
export default function Leasing101FindYourPlace() {
    return (
            ...
            <div className="container">
                ...
                <div className="row wow align-items-center justify-content-between">
                    <div className="col-md-5">
                        <img className="img-fluid" src="/img/livingHere/leasing/Service-is-at-your-fingertips.jpg" alt="EASIER ROUTINES" />
                    </div>
